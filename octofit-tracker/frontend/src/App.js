  ...
  return (
    <Router>
      ...
      <div className="container mt-4">
        <h1 className="display-4 mb-4 text-center">Octofit Tracker Fitness App</h1>
        <Routes>
          ...
          <Route path="/" element={<div className="card p-4 text-center"><h2 className="card-title">Welcome to Octofit Tracker!</h2><p className="card-text">Track your fitness activities, join teams, and compete on the leaderboard.</p></div>} />
        </Routes>
      </div>
    </Router>
  );
